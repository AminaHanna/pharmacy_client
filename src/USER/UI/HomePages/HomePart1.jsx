        ...
        <div className="flex flex-col lg:flex-row md:flex-col sm:flex-col bg-slate-100 justify-evenly items-center">
          <div className="text-center md:text-left mb-4 sm:mb-0 mt-4">
            ...
            <Link to={'/start-shopping'}>
              <button className='bg-pink-900 hover:bg-pink-700 text-white p-1 sm:p-3 ml-5 rounded'>Start Shopping <i class="fa-solid fa-bag-shopping"></i></button>
            </Link>
            
          </div>
            <img src={image} alt="" className='w-[250px] sm:w-[500px]' />
        </div>
