...
function HomePart3() {
  return (
    <>
    <div className="flex flex-col lg:flex-row md:flex-col sm:flex-col items-center justify-evenly py-5 bg-slate-100">
      <div className="">
        <p className='font-bold my-5'>Todays Hot Offer</p>
        <p className='font-bold text-2xl sm:text-3xl lg:text-5xl font-mono'>Unlock 50% Off on<br/>Essential Medicines!</p>
