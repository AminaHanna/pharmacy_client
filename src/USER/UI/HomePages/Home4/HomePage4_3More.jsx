    ...
    <div className="">
        ...
        { blogs?.map((item,index)=>{
            if(index==2){
                return(
                    <>
                    <div className="flex w-[550px] sm:flex-row flex-col items-center bg-pink-50 rounded-xl m-2 p-10 gap-1">
...
export default HomePage4_3More;
