    ...
    <div className="">
        { blogs?.map((item,index)=>{
            if(index==1){
                return(
                    <>
                    <div className="flex sm:w-[550px] sm:flex-row flex-col items-center bg-gray-100 rounded-xl m-2 p-10 gap-1">
...
export default HomePage4_2More;
