...
function MedicalProducts() {
  ...
  return (
    ...
    <div className="text-right mr-10">
        <Link to={'/medical-products'}><button className='text-pink-900 sm:text-xl font-mono'>View All <i class="fa-solid fa-arrow-right"></i></button></Link>
    </div>
    
    {/* Medical Products start */}
