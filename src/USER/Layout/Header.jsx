...
function Header() {
  return (
    ...
    <div className="flex flex-row justify-between bg-pink-900 p-5 items-center">
      ...
      <div className="text-white text-center text-2xl mb-4 sm:mb-0">ᕵᕼᗩᖇᙏᗩᙅᖻ</div>
    ...
    {/* search bar end */}
        ...
        <div className="flex items-center gap-5">
          ...
          <button className='text-white text-xl sm:block hidden'><i class="fa-regular fa-heart"></i></button>

          <button className='text-white text-xl sm:block hidden'><i class="fa-solid fa-cart-shopping"></i></button>
